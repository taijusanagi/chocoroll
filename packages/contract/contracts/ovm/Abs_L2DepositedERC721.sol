 ...
 */
abstract contract Abs_L2DepositedERC721 is iOVM_L2DepositedERC721, OVM_CrossDomainEnabled {
    /*******************
     * Contract Events *
     *******************/
     ...
     * @param _tokenId ERC721 token to withdraw
     */
    function withdrawTo(address _to, uint256 _tokenId) external override onlyInitialized() {
    ...
    ) external override onlyInitialized() onlyFromCrossDomainAccount(address(tokenGateway)) {
