...
abstract contract Abs_L1ERC721Gateway is iOVM_L1ERC721Gateway, OVM_CrossDomainEnabled {
    ...
    function getFinalizeDepositGas() public view returns (uint32) {
     ...
     */
    function deposit(uint256 _tokenId) public override {
     ...
     * @param _tokenId ERC721 token to deposit
     */
    function depositTo(address _to, uint256 _tokenId) public override {
    ...
    function _initiateDeposit(
        ...
        _handleInitiateDeposit(_from, _to, _tokenId);
